...
class TestFileStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        new_state = State(name="orlando")
        new_state.save()
        new_user = User(email="dav@trial.com", password="password")
        new_user.save()
        self.assertIs(new_state, models.storage.get("State", new_state.id))
        self.assertIs(None, models.storage.get("State", "hii"))
        self.assertIs(None, models.storage.get("hii", "hii"))
    ...
    def test_count(self):
        ...
        self.assertEqual(models.storage.count("hii"), 0)
        new_state = State(name="orlando")
        new_state.save()
        new_user = User(email="dav@trial.com", password="password")
        new_user.save()
